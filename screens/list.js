...
const List = () => {
            ...
            >
                <View style={styles.modal}>
                    <View style={styles.modalContent}>
                        ...
                        <Separator height={10} />
                        <Button title="Go to Article" color="#FFC300" style={styles.showAlertButton} onPress={showAlert} />
                        <Button title="Close" color="#C00303" style={styles.closeButton} onPress={() => setModalVisible(false)} />
                    </View>
                </View>
            </Modal>
        );
    ...
    const showAlert = () => {
        ...
        Alert.alert("Alert", "Sorry, the Article is not yet available"), [
